...
export default function PhilosophyPage() {
  return (
    <div style={{ background: "#0d0d0d", color: "#e8e2d9" }}>
      ...
      <section className="relative min-h-screen flex items-end overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, rgba(13,13,13,0.55) 0%, rgba(13,13,13,0.30) 40%, rgba(13,13,13,0.92) 80%, #0d0d0d 100%)" }} />
        </div>

        <div className="relative z-10 max-w-4xl mx-auto px-6 pb-20 pt-40">
          <p className="text-xs font-bold uppercase tracking-[0.25em] mb-6" style={{ color: "rgba(232,226,217,0.45)" }}>
            Jamie&apos;s Finance — Personal Philosophy
          </p>
          <h1 className="font-display text-6xl sm:text-7xl md:text-8xl leading-none mb-8" style={{ color: "#e8e2d9" }}>
            What if<br />this does<br /><em>work?</em>
          </h1>
          <p className="text-lg sm:text-xl max-w-xl" style={{ color: "rgba(232,226,217,0.65)", lineHeight: 1.8 }}>
      ...
      <section className="py-24 px-6" style={{ background: "#0d0d0d" }}>
        <div className="max-w-3xl mx-auto text-center">
          <div className="w-px h-16 mx-auto mb-10" style={{ background: "rgba(232,226,217,0.15)" }} />
          <blockquote className="font-display text-3xl sm:text-4xl md:text-5xl leading-tight mb-6" style={{ color: "#e8e2d9" }}>
            &ldquo;The impediment to action<br />advances action. What stands<br />in the way becomes the way.&rdquo;
          </blockquote>
          <p className="text-sm font-bold uppercase tracking-widest" style={{ color: "rgba(232,226,217,0.35)" }}>
            — Marcus Aurelius
          </p>
          <div className="w-px h-16 mx-auto mt-10" style={{ background: "rgba(232,226,217,0.15)" }} />
        </div>
      </section>

      {/* ── Core Values ── */}
      <section className="py-20 px-6" style={{ background: "#111010" }}>
        <div className="max-w-4xl mx-auto">
          <p className="text-xs font-bold uppercase tracking-[0.25em] mb-4" style={{ color: "rgba(232,226,217,0.35)" }}>
            Core Values
          </p>
          <h2 className="font-display text-4xl sm:text-5xl mb-16" style={{ color: "#e8e2d9" }}>
            What I believe
          </h2>

          <div className="grid md:grid-cols-2 gap-px" style={{ background: "rgba(232,226,217,0.08)" }}>
            {[
              {
                num: "01",
              ...
              <div key={v.num} className="p-8 sm:p-10" style={{ background: "#111010" }}>
                <p className="font-display text-5xl mb-6" style={{ color: "rgba(232,226,217,0.10)" }}>{v.num}</p>
                <h3 className="font-display text-xl sm:text-2xl mb-4" style={{ color: "#e8e2d9" }}>{v.title}</h3>
                <p className="text-sm leading-relaxed" style={{ color: "rgba(232,226,217,0.55)", lineHeight: 1.85 }}>{v.body}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative h-[60vh] overflow-hidden">
        <Image
          ...
          className="object-cover object-center"
        />
        <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, #111010 0%, transparent 25%, transparent 75%, #0d0d0d 100%)" }} />
        <div className="absolute inset-0 flex items-center justify-center">
          <blockquote className="text-center px-6 max-w-2xl">
            <p className="font-display text-2xl sm:text-3xl md:text-4xl leading-tight mb-4" style={{ color: "#e8e2d9", textShadow: "0 2px 20px rgba(0,0,0,0.8)" }}>
              &ldquo;We suffer more in imagination<br />than in reality.&rdquo;
            </p>
            <p className="text-xs font-bold uppercase tracking-widest" style={{ color: "rgba(232,226,217,0.55)", textShadow: "0 1px 8px rgba(0,0,0,0.9)" }}>
              — Seneca
            </p>
          </blockquote>
        </div>
      ...
      <section className="py-24 px-6" style={{ background: "#0d0d0d" }}>
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <h2 className="font-display text-4xl sm:text-5xl leading-tight mb-8" style={{ color: "#e8e2d9" }}>
              Never give up.<br />Always try.
            </h2>
            <p className="text-sm leading-relaxed mb-6" style={{ color: "rgba(232,226,217,0.55)", lineHeight: 1.85 }}>
            ...
            <p className="text-sm leading-relaxed" style={{ color: "rgba(232,226,217,0.55)", lineHeight: 1.85 }}>
          ...
          <div className="space-y-6">
            {/* Failure card */}
            <div className="rounded-2xl p-7 border" style={{ background: "#161616", borderColor: "rgba(232,226,217,0.08)" }}>
              <p className="font-display text-lg mb-3" style={{ color: "#e8e2d9" }}>Failure is the most important thing.</p>
              <p className="text-sm leading-relaxed" style={{ color: "rgba(232,226,217,0.50)", lineHeight: 1.85 }}>
            ...
            <div className="rounded-2xl p-7 border" style={{ background: "#161616", borderColor: "rgba(232,226,217,0.08)" }}>
              <p className="font-display text-lg mb-3" style={{ color: "#e8e2d9" }}>&ldquo;What if this does work?&rdquo;</p>
              <p className="text-sm leading-relaxed" style={{ color: "rgba(232,226,217,0.50)", lineHeight: 1.85 }}>
      ...
      <section className="py-20 px-6" style={{ background: "#111010" }}>
        <div className="max-w-4xl mx-auto">
          <p className="text-xs font-bold uppercase tracking-[0.25em] mb-12 text-center" style={{ color: "rgba(232,226,217,0.30)" }}>
            Words that guide me
          </p>
          <div className="grid sm:grid-cols-2 gap-6">
            {stoicQuotes.map((q) => (
              <div key={q.author + q.text.slice(0, 10)} className="rounded-2xl p-7 border" style={{ background: "#0d0d0d", borderColor: "rgba(232,226,217,0.07)" }}>
                <p className="font-display text-xl leading-snug mb-5" style={{ color: "#e8e2d9" }}>
                  &ldquo;{q.text}&rdquo;
                </p>
                <p className="text-xs font-bold uppercase tracking-widest" style={{ color: "rgba(232,226,217,0.30)" }}>
                  — {q.author}
                </p>
              </div>
            ))}
      ...
      <section className="relative h-[50vh] overflow-hidden">
        <Image
          ...
          className="object-cover object-center"
        />
        <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, #111010 0%, rgba(13,13,13,0.5) 40%, rgba(13,13,13,0.5) 60%, #0d0d0d 100%)" }} />
      </section>
      ...
      <section className="py-24 px-6" style={{ background: "#0d0d0d" }}>
        <div className="max-w-3xl mx-auto">
          ...
          <h2 className="font-display text-4xl sm:text-5xl leading-tight mb-10" style={{ color: "#e8e2d9" }}>
            Stoicism is the<br />ultimate money mindset.
          </h2>
          <div className="space-y-6 text-sm leading-relaxed" style={{ color: "rgba(232,226,217,0.55)", lineHeight: 1.95 }}>
            <p>
      ...
      {/* ── CTA ── */}
      <section className="py-20 px-6 border-t" style={{ background: "#0d0d0d", borderColor: "rgba(232,226,217,0.08)" }}>
        <div className="max-w-3xl mx-auto flex flex-col sm:flex-row sm:items-center justify-between gap-8">
          <div>
            <p className="font-display text-3xl sm:text-4xl mb-3" style={{ color: "#e8e2d9" }}>
              Ready to start?
            </p>
            <p className="text-sm" style={{ color: "rgba(232,226,217,0.45)", lineHeight: 1.7 }}>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Link href="/guides/start-investing-25-a-month"
              ...
              style={{ background: "#e8e2d9", color: "#0d0d0d" }}>
              Start investing
            ...
            <Link href="/"
              ...
              style={{ borderColor: "rgba(232,226,217,0.20)", color: "rgba(232,226,217,0.60)" }}>
              Back home
            </Link>
          </div>
        </div>
